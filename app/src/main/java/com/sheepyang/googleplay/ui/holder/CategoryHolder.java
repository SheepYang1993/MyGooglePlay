...
public class CategoryHolder extends BaseHolder<CategoryInfo> implements
	...
	public void refreshView(CategoryInfo data) {
		...
		x.image().bind(ivIcon1, HttpHelper.URL + "image?name=" + data.url1/*, mImageOptions*/);
		x.image().bind(ivIcon2, HttpHelper.URL + "image?name=" + data.url2/*, mImageOptions*/);
		x.image().bind(ivIcon3, HttpHelper.URL + "image?name=" + data.url3/*, mImageOptions*/);
